...
router.get('/', function(req, res, next) {
  let jsonResponse = {
    "handsetCards":[
      ...
      { imageName: 'offer4',title: 'Get bonus discounts on holiday packages', cols: 1, rows: 1 ,route:'/packages'},
    ...
    "webCards":[
      ...
      { imageName: 'offer4',title: 'Get bonus discounts on holiday packages', cols: 1, rows: 2 ,route:'/packages'},
      { imageName: 'offer',title: 'Flights starting from as low as Rs.700', cols: 1, rows: 1 ,route:'/flights'}
    ]
